  ...
  return (
        ...
        <div className="nlogin-container" id="container">
            ...
            <form>
                ...
                {/* <div className="nlogin-social-icons">
                <a href="#" className="icon">
                    <i className="fa-brands fa-google-plus-g" />
                </a>
                <a href="#" className="nlogin-icon">
            ...
            <form>
                ...
                <input type="text" 
                    ...
                    onChange={inputHandler}
                />
                <p className='hover:cursor-pointer'>Forget Your Password?</p>
            ...
            <div className="nlogin-toggle">
                ...
                <h1 className="text-3xl font-bold text-white text-center">Welcome to<span style={{color:'#baa6f2',fontSize:'2rem'}}> ChatBox </span></h1>
